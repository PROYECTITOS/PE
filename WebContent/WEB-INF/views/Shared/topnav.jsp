<!-- Main navbar -->
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.html"><img src="<c:url value="/resources/assets/images/logo_light.png" />" alt=""></a>
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content">
						...
						<ul class="media-list dropdown-content-body width-300">
							<li class="media">
								<div class="media-left"><img src="<c:url value="/resources/assets/images/demo/users/face18.jpg" />" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
							...
							<li class="media">
								<div class="media-left"><img src="<c:url value="/resources/assets/images/demo/users/face24.jpg" />" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="<c:url value="/resources/assets/images/flags/gb.png" />" class="position-left" alt=""> English
						<span class="caret"></span>
					</a>

					<ul class="dropdown-menu">
						<li>
							<a class="deutsch"><img src="assets/images/flags/de.png" alt=""> Deutsch</a>
						</li>
						<li>
							<a class="ukrainian"><img src="assets/images/flags/ua.png" alt=""> Українська</a>
						</li>
						<li>
							<a class="english"><img src="assets/images/flags/gb.png" alt=""> English</a>
						</li>
						<li>
							<a class="espana"><img src="assets/images/flags/es.png" alt=""> España</a>
						</li>
						<li>
							<a class="russian"><img src="assets/images/flags/ru.png" alt=""> Русский</a>
						</li>
					</ul>
				</li>
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="<c:url value="/resources/assets/images/demo/users/face9.jpg" />" alt="">
						<span>Mark Arroyo Garcia</span>
						<i class="caret"></i>
					</a>
